...
import piccc from '../../assets/icon/icon-emtion.png'

const Header = () => (
  <View style={styles.HeaderContainer}>
    <Text style={styles.HeaderText}>Emoticon</Text>
    <Text style={styles.Filtertext}> Back </Text>
    <Text style={styles.ti1text}>Title1</Text>
    <Text style={styles.t1text}>13 apr 2021</Text>
    ...
    <Text style={styles.restext}>Em1</Text>
